...
namespace gopclient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrganizationServiceResponse :  IEquatable<OrganizationServiceResponse>
    { 
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OrganizationServiceResponse" /> class.
        /// Initializes a new instance of the <see cref="OrganizationServiceResponse" />class.
        /// </summary>
        ...
        public OrganizationServiceResponse(string ResultCode = null, string ResultDescription = null, OrganizationResponse Body = null, ResultTypeEnum? ResultType = null)
        {
        ...
        public OrganizationResponse Body { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OrganizationServiceResponse {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as OrganizationServiceResponse);
        }

        /// <summary>
        /// Returns true if OrganizationServiceResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of OrganizationServiceResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrganizationServiceResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
