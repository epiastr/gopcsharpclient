...
namespace gopclient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DeleteOfferServiceResponse :  IEquatable<DeleteOfferServiceResponse>
    { 
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteOfferServiceResponse" /> class.
        /// Initializes a new instance of the <see cref="DeleteOfferServiceResponse" />class.
        /// </summary>
        ...
        public DeleteOfferServiceResponse(string ResultCode = null, string ResultDescription = null, DeleteOfferResponse Body = null, ResultTypeEnum? ResultType = null)
        {
        ...
        public DeleteOfferResponse Body { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeleteOfferServiceResponse {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as DeleteOfferServiceResponse);
        }

        /// <summary>
        /// Returns true if DeleteOfferServiceResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of DeleteOfferServiceResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeleteOfferServiceResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
