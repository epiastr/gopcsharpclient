...
namespace gopclient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AdvanceResultServiceResponse :  IEquatable<AdvanceResultServiceResponse>
    { 
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AdvanceResultServiceResponse" /> class.
        /// Initializes a new instance of the <see cref="AdvanceResultServiceResponse" />class.
        /// </summary>
        ...
        public AdvanceResultServiceResponse(string ResultCode = null, string ResultDescription = null, AdvanceResultResponse Body = null, ResultTypeEnum? ResultType = null)
        {
        ...
        public AdvanceResultResponse Body { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AdvanceResultServiceResponse);
        }

        /// <summary>
        /// Returns true if AdvanceResultServiceResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of AdvanceResultServiceResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdvanceResultServiceResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
