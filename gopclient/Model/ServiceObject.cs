...
namespace gopclient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ServiceObject :  IEquatable<ServiceObject>
    { 
        ...
        public ServiceObject(List<Header> Header = null, Object Body = null)
        {
            this.Header = Header;
            this.Body = Body;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ServiceObject);
        }

        /// <summary>
        /// Returns true if ServiceObject instances are equal
        /// </summary>
        /// <param name="other">Instance of ServiceObject to be compared</param>
        /// <returns>Boolean</returns>
