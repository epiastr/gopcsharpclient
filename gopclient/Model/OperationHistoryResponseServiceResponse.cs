...
namespace gopclient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OperationHistoryResponseServiceResponse :  IEquatable<OperationHistoryResponseServiceResponse>
    { 
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OperationHistoryResponseServiceResponse" /> class.
        /// Initializes a new instance of the <see cref="OperationHistoryResponseServiceResponse" />class.
        /// </summary>
        ...
        public OperationHistoryResponseServiceResponse(string ResultCode = null, string ResultDescription = null, OperationHistoryResponse Body = null, ResultTypeEnum? ResultType = null)
        {
        ...
        public OperationHistoryResponse Body { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as OperationHistoryResponseServiceResponse);
        }

        /// <summary>
        /// Returns true if OperationHistoryResponseServiceResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of OperationHistoryResponseServiceResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OperationHistoryResponseServiceResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
