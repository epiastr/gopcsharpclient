...
namespace gopclient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MinMaxPriceServiceResponse :  IEquatable<MinMaxPriceServiceResponse>
    { 
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MinMaxPriceServiceResponse" /> class.
        /// Initializes a new instance of the <see cref="MinMaxPriceServiceResponse" />class.
        /// </summary>
        ...
        public MinMaxPriceServiceResponse(string ResultCode = null, string ResultDescription = null, MinMaxPriceResponse Body = null, ResultTypeEnum? ResultType = null)
        {
        ...
        public MinMaxPriceResponse Body { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as MinMaxPriceServiceResponse);
        }

        /// <summary>
        /// Returns true if MinMaxPriceServiceResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of MinMaxPriceServiceResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MinMaxPriceServiceResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
