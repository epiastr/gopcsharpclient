...
namespace gopclient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContractServiceResponse :  IEquatable<ContractServiceResponse>
    { 
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ContractServiceResponse" /> class.
        /// Initializes a new instance of the <see cref="ContractServiceResponse" />class.
        /// </summary>
        ...
        public ContractServiceResponse(string ResultCode = null, string ResultDescription = null, ContractResponse Body = null, ResultTypeEnum? ResultType = null)
        {
        ...
        public ContractResponse Body { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContractServiceResponse {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ContractServiceResponse);
        }

        /// <summary>
        /// Returns true if ContractServiceResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of ContractServiceResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContractServiceResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
