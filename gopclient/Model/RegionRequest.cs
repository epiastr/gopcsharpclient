...
namespace gopclient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RegionRequest :  IEquatable<RegionRequest>
    { 
        ...
        public RegionRequest(DateTime? DeliveryDay = null)
        {
            // to ensure "DeliveryDay" is required (not null)
            if (DeliveryDay == null)
            {
                throw new InvalidDataException("DeliveryDay is a required property for RegionRequest and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RegionRequest);
        }

        /// <summary>
        /// Returns true if RegionRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of RegionRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RegionRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
