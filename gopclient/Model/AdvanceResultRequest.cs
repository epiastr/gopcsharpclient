...
namespace gopclient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AdvanceResultRequest :  IEquatable<AdvanceResultRequest>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="AdvanceResultRequest" /> class.
        /// Initializes a new instance of the <see cref="AdvanceResultRequest" />class.
        /// </summary>
        /// <param name="DeliveryDay">This field keeps Delivery Date..</param>
        /// <param name="Region">This field keeps Region Information..</param>

        public AdvanceResultRequest(DateTime? DeliveryDay = null, string Region = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AdvanceResultRequest {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AdvanceResultRequest);
        }

        /// <summary>
        /// Returns true if AdvanceResultRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of AdvanceResultRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdvanceResultRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
