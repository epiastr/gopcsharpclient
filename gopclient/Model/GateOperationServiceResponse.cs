...
{
    [DataContract]
    public partial class GateOperationServiceResponse : IEquatable<GateOperationServiceResponse>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GateOperationServiceResponse" /> class.
        /// Initializes a new instance of the <see cref="GateOperationServiceResponse" />class.
        /// </summary>
        ...
        public GateOperationServiceResponse(string ResultCode = null, string ResultDescription = null, GateOperationResponse Body = null, ResultTypeEnum? ResultType = null)
        {
        ...
        public GateOperationResponse Body { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GateOperationServiceResponse {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GateOperationServiceResponse);
        }

        /// <summary>
        /// Returns true if GateOperationServiceResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of GateOperationServiceResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GateOperationServiceResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
