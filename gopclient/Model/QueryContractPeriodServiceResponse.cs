...
namespace gopclient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QueryContractPeriodServiceResponse :  IEquatable<QueryContractPeriodServiceResponse>
    { 
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="QueryContractPeriodServiceResponse" /> class.
        /// Initializes a new instance of the <see cref="QueryContractPeriodServiceResponse" />class.
        /// </summary>
        ...
        public QueryContractPeriodServiceResponse(string ResultCode = null, string ResultDescription = null, QueryContractPeriodResponse Body = null, ResultTypeEnum? ResultType = null)
        {
        ...
        public QueryContractPeriodResponse Body { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as QueryContractPeriodServiceResponse);
        }

        /// <summary>
        /// Returns true if QueryContractPeriodServiceResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of QueryContractPeriodServiceResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueryContractPeriodServiceResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
