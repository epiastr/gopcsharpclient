...
namespace gopclient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QueryOfferServiceResponse :  IEquatable<QueryOfferServiceResponse>
    { 
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="QueryOfferServiceResponse" /> class.
        /// Initializes a new instance of the <see cref="QueryOfferServiceResponse" />class.
        /// </summary>
        ...
        public QueryOfferServiceResponse(string ResultCode = null, string ResultDescription = null, QueryOfferResponse Body = null, ResultTypeEnum? ResultType = null)
        {
        ...
        public QueryOfferResponse Body { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as QueryOfferServiceResponse);
        }

        /// <summary>
        /// Returns true if QueryOfferServiceResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of QueryOfferServiceResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueryOfferServiceResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
