...
namespace gopclient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BooleanServiceResponse :  IEquatable<BooleanServiceResponse>
    { 
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BooleanServiceResponse" /> class.
        /// Initializes a new instance of the <see cref="BooleanServiceResponse" />class.
        /// </summary>
        ...
        /// <param name="Body">Body (default to false).</param>
        ...
        public BooleanServiceResponse(string ResultCode = null, string ResultDescription = null, bool? Body = null, ResultTypeEnum? ResultType = null)
        {
            this.ResultCode = ResultCode;
            this.ResultDescription = ResultDescription;
            // use default value if no "Body" provided
            if (Body == null)
            {
                this.Body = false;
            }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as BooleanServiceResponse);
        }

        /// <summary>
        /// Returns true if BooleanServiceResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of BooleanServiceResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BooleanServiceResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
